...
class MatchsTest(TestCase):
    def setUp(self):
        ...
        self.user1 = CustomUser.objects.create_user(username="user1", email="test@test.com", password="test")
        self.user2 = "user2"
        self.match = Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        self.match1 = Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        self.match2 = Match.objects.create(player1=self.user2, player2=self.user1.username, winner=self.user2, loser=self.user1.username, player1_score=3, player2_score=1)
    ...
    def test_get_user_win_streak(self):
        ...
        Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
        Match.objects.create(player1=self.user1.username, player2=self.user2, winner=self.user1.username, loser=self.user2, player1_score=3, player2_score=1)
