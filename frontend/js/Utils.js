...
import { injectElementTranslations } from "./modules/translationsModule/translationsModule.js";
...
function showAlert(message, success, button) {
	...
	injectElementTranslations(`#alert${alertId}`);
