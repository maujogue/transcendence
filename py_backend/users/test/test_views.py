...
class ProfileUpdate(TestCase):
    ...
    #     with open('media/hunter.jpg', 'rb') as image_file:
    #         multipart_data = MultipartEncoder(
    #             fields={
    #                 'username': 'Hunter',
    #                 'avatar': ('media/hunter.jpg', image_file, 'image/jpeg')
    #             }
    #         )
    ...
    #     self.assertEqual(response.status_code, 200)
    #     self.assertEqual(self.user.avatar, 'hunter.jpg')


    # def test_avatar_upload_2(self):
    #     avatar_file = SimpleUploadedFile('media/hunter.jpg', b'file_content', content_type='image/jpeg')
    #     data = {
    #         'username': 'Hunter',
    #     }
        
    #     response = self.client.post(reverse('update_profile'), data=data, files={'avatar': avatar_file})
    ...
    def test_avatar_upload(self):
        avatar_file = SimpleUploadedFile('hunter.jpg', b'hunter.jpg', content_type='image/jpeg')
        response = self.client.post(
            reverse('update_profile'),
            data={'username': 'Hunter'},
