...
class TournamentMatch(models.Model):
	...
	player1 =  models.ForeignKey(CustomUser, related_name='t_player1',on_delete=models.SET_DEFAULT, default=None, null=True)
	player2 = models.ForeignKey(CustomUser, related_name='t_player2',on_delete=models.SET_DEFAULT, default=None, null=True)
	winner = models.ForeignKey(CustomUser, related_name='m_winner',on_delete=models.SET_DEFAULT, default=None, null=True)
